...
<div class="hidden h-screen grid-cols-2 xl:grid">
	...
	<div class="col-span-2 flex flex-col p-8 lg:col-span-1">
		<div class="flex flex-none justify-end">
			<button class="uk-btn uk-btn-ghost" onclick={demo}>Login</button>
		</div>
		...
		<div class="flex flex-1 items-center justify-center">
			<div class="w-80 space-y-6">
				...
				<div class="space-y-2">
					...
					>
						{#if isLoading}
							<span class="mr-2" data-uk-spinner="ratio: 0.54"></span>
						{/if}
						Sign in with Email
					</button>
				</div>
				...
				<button class="uk-btn uk-btn-default w-full" onclick={demo}>
				...
				<p class="px-8 text-center text-sm text-muted-foreground">
					...
					and
					<a class="underline underline-offset-4 hover:text-primary" href="#" onclick={demo}>
						Privacy Policy
					</a>.
				</p>
			</div>
