...
<div class="uk-card">
	<div class="uk-card-header space-y-2">
		...
		<p class="text-muted-foreground">Enter your email below to create your account</p>
	</div>

	<div class="uk-card-body space-y-4">
		<div class="grid grid-cols-2 gap-6">
			<button class="uk-btn uk-btn-default" onclick={demo}>
		...
		<div class="space-y-2">
			...
			<input class="uk-input" id="email" type="text" placeholder="m@example.com" />
		</div>
	...
	<div class="uk-card-footer">
		<button class="uk-btn uk-btn-primary w-full" onclick={demo}> Create account </button>
	</div>
</div>
